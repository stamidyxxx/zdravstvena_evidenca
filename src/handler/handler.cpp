...
int Handler::Run(function<void()> func)
{
    ...
    colors[ImGuiCol_TextDisabled] = ImVec4(1.00f, 0.47f, 0.47f, 1.00f);
    colors[ImGuiCol_WindowBg] = ImVec4(0.06f, 0.06f, 0.06f, 0.94f);
    colors[ImGuiCol_ChildBg] = ImVec4(0.30f, 0.72f, 1.00f, 0.08f);
    colors[ImGuiCol_PopupBg] = ImVec4(0.08f, 0.08f, 0.08f, 0.94f);
    colors[ImGuiCol_Border] = ImVec4(0.32f, 0.32f, 0.32f, 1.00f);
    colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    colors[ImGuiCol_FrameBg] = ImVec4(0.09f, 0.42f, 1.00f, 0.41f);
    colors[ImGuiCol_FrameBgHovered] = ImVec4(0.15f, 0.39f, 1.00f, 0.34f);
    colors[ImGuiCol_FrameBgActive] = ImVec4(0.11f, 0.32f, 1.00f, 0.69f);
    ...
    colors[ImGuiCol_SliderGrab] = ImVec4(0.00f, 0.03f, 0.08f, 0.83f);
    colors[ImGuiCol_SliderGrabActive] = ImVec4(0.00f, 0.03f, 0.08f, 0.94f);
